...
const IT_TRACK_GROUPS = [
  {
    "group": "Системный анализ",
    "items": [
      {
        "title": "Системный аналитик",
        "desc": "Для тех, кто живёт в Москве, в том числе выпускников онлайн-школ\nФормат работы: гибридный\n\nЧто предстоит делать\n- Анализировать и уточнять бизнес- и системные требования, выстраивать новые процессы\n- Проектировать и документировать новые фичи\n- Взаимодействовать с коллегами и интегрировать новые решения\n- Сопровождать и поддерживать существующие системы\n\nНеобходимые навыки\n- Базовое знание различных способов интеграций и типов архитектур\n- Базовое знание нотаций UML и BPMN\n- Базовое знание SQL (Select, Join), умение писать простые запросы\n- Знание способов выявления требований"
      }
    ]
  },
  {
    ...
    "items": [
      ...
      {
        "title": "Количественный аналитик",
        "desc": "Формат работы: гибридный/удаленный\n\nЧто предстоит делать \n- Участвовать в разработке количественных инвестиционных стратегиях на глобальных финансовых рынках и улучшать их с помощью машинного обучения\n- Создавать количественные модели объяснения доходности клиентской стратегии (от линейной регрессии с регуляризацией до нейронных сетей), которая в дальнейшем будет использоваться в LLM-агенте\n- Подбирать релевантные фичи для моделей предсказания и объяснения случайных переменных, которые в дальнейшем будут использоваться для создания и улучшения стратегий на финансовых рынках\n- Имплементировать новые модели и метрики для анализа существующих стратегий, предлагать новые идеи с точки зрения финансовой логики\n\nНеобходимые навыки\n- Знания в математической статистике (линейная регрессия, построение статистических эстиматоров, бутстраппинг, multiple testing)\n- Знания в области финансов, asset pricing и высокий уровень понимания работы финансовых рынков\n- Умение писать код на Python (включая ООП)\n- Знание базовых принципов построения факторных моделей и экономической логики, которая лежит в их основе (CAPM, Fama-French 3/5 Factor Model)"
      }
    ]
  },
  {
    ...
    "items": [
      {
        ...
        "desc": "Подходит выпускникам онлайн-школ\nФормат работы: гибридный/удаленный\n\nЧто предстоит делать \n- Организовывать, поддерживать и развивать инфраструктуру тестовых и продуктивных сред\n- Исследовать инциденты\n- Организовывать и развивать pipeline CI/CD\n- Обучаться и участвовать в разработке ПО\n- Помогать и консультировать другие команды в подразделении\n\nБудет плюсом\n- Контейнеризация приложений\n- Интеграция и сборка систем\n- Оркестрация контейнеризированных приложений\n- Использование SHELL\n- Администрирование и сопровождение операционных систем (Windows и Linux)\n- Эксплуатация систем конфигураций\n- Базовые знания SQL (Select, Joins), умение писать простые запросы \n- Знание языков программирования или скриптов (например, Python)"
      },
      {
    ...
    "items": [
      {
        ...
        "desc": "Формат работы: гибридный/удаленный\n\nЧто предстоит делать\n- Проектировать и реализовывать новые фичи\n- Писать читаемый и поддерживаемый код\n- Дорабатывать, поддерживать и оптимизировать существующий функционал\n- Участвовать в развитии продукта: от обсуждения задач до запуска их в работу\n\nНеобходимые навыки\n- Уверенное владение синтаксисом Python и понимание базовых принципов этого языка (типизация, память и прочее)\n- Понимание базовых принципов и опыт работы с Git (ветки, MR, ревью)\n- Базовые знания SQL (Select, Join), умение писать простые запросы"
      },
      {
        "title": "Java-разработчик",
        "desc": "Подходит выпускникам онлайн-школ\nФормат работы: гибридный/удаленный\n\nЧто предстоит делать \n- Проектировать и разрабатывать новые функции на Java\n- Дорабатывать и поддерживать существующий функционал\n- Участвовать в развитии продукта банка\n- Погружаться в процессы разработки по технологии Agile\n\nНеобходимые навыки\n- Базовое владение Java или Kotlin\n- Знание SQL на уровне запросов со слиянием таблиц и агрегацией данных\n- Владение Git на базовом уровне (создание и слияние веток)\n- Знание жизненного цикла IT-продукта"
      },
      {
        "title": "Фронтенд-разработчик",
        "desc": "Формат работы: гибридный/удаленный\n\nЧто предстоит делать\n- Проектировать и реализовывать новые фичи\n- Дорабатывать, поддерживать и оптимизировать уже существующий функционал\n- Участвовать в развитии продукта: от обсуждения задач до запуска их в работу\n\nНеобходимые навыки\n- Базовые знания фронтенд-разработки (HTML, CSS, JavaScript, TypeScript)\n- Базовые знания фронтенд-фреймворков (React)\n- Понимание принципов работы HTTP"
      },
      {
        "title": "Android-разработчик",
        "desc": "Формат работы: гибридный/удаленный\n\nЧто предстоит делать\n- Разрабатывать с командой новые решения для персонализации целей пользователей\n- Принимать участие и обсуждать создание новых способов для отслеживания доходов клиентов банка\n\nНеобходимые навыки\n- Знание Kotlin\n- Наличие pet-проектов на Android"
      }
    ]
  }
];
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "desc": "Подходит выпускникам онлайн-школ\nФормат работы: гибридный/удаленный\n\nЧто предстоит делать\n- Ставить и описывать задачи для команды разработки, а также помогать команде преодолевать препятствия на пути их реализации\n- Следить за актуальностью задач в бэклоге и вовремя обновлять приоритеты\n- Как стейкхолдер ставить и согласовывать задачи для смежных команд, отслеживать прогресс и эскалировать проблемы со сроками\n- Помогать дизайнеру в выработке решений на стадии проектирования\n- Создавать схемы бизнес-процессов для согласования решений с другими командами\n- Организовывать демо по продукту, собирать обратную связь от бизнес-заказчиков и трансформировать её в понятные задачи\n- Выявлять слабые места в продукте и инициировать изменения, которые улучшат его качество и пользовательский опыт\n- Взаимодействовать с бизнес-заказчиками на всех этапах работы — от постановки задач до обсуждения результатов\n\nНеобходимые навыки\n- Знание Excel на среднем уровне\n- Продвинутый пользователь PowerPoint и Figma\n- Понимание фондового рынка (инвестиции)\n- Обучение на курсах по продуктовому менеджменту\n- Коммуникабельность, нацеленность на результат, проактивность\n- Интерес к тематике ИИ и машинного обучения, знание существующих на рынке инструментов"
      }
    ]
  },
  {
