...
const NONIT_TRACK_GROUPS = [
    ...
    items: [
      {
        ...
        desc: "Формат работы: гибридный\n\nЧто предстоит делать:\n- Проводить предварительный анализ зоны аудита\n- Работать с данными с использованием LLM и ИИ-агентов\n\nМы ждем:\n- Английский язык на уровне Upper-Intermediate (B2) и выше\n- Продвинутое владение Excel"
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        desc: "Формат работы: гибридный\n\nЧто предстоит делать:\n- Анализировать обратную связь клиентов по инвестиционным продуктам\n- Участвовать в клиентских исследованиях\n\nМы ждем:\n- Английский язык на уровне Intermediate (B1) и выше\n- Владение Excel на среднем уровне"
      },
      {
        title: "Продуктовый менеджер в торговом финансировании",
        desc: "Формат работы: очно в офисе\n\nЧто предстоит делать:\n- Изучать клиентский опыт — проводить аналитику рынка, собирать обратную связь\n- Строить CJM, описывать профиль клиента и проводить CustDev-интервью\n\nМы ждем:\n- Знание Excel на продвинутом уровне\n- Умение структурно рассказать о своей идее"
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        desc: "Формат работы: гибридный\n\nЧто предстоит делать:\n- Анализировать розничный кредитный портфель и тенденции его развития\n- Определять риски розничного кредитования\n\nМы ждем:\n- Английский язык на уровне Upper-Intermediate (B2) и выше\n- Умение работать в Excel на продвинутом уровне"
      }
    ]
  },
  {
    group: "Соответствие и контроль",
    items: [
      {
        title: "Комплаенс-контроль на финансовых рынках",
        desc: "Формат работы: очно в офисе\n\nЧто предстоит делать:\n- Оценивать соответствие деятельности дочерней компании требованиям законодательства\n- Выявлять и анализировать комплаенс-риски\n\nМы ждем:\n- Английский язык на уровне Upper-Intermediate (B2) и выше\n- Владение Excel на продвинутом уровне"
      },
      {
        title: "Антикорупционный комплаенс",
        desc: "Формат работы: очно в офисе\n\nЧто предстоит делать:\n- Участвовать в оценке конфликтов интересов и разработке мер по их минимизации\n- Вести и актуализировать профили сотрудников\n\nМы ждем:\n- Понимание, что такое комплаенс\n- Умение работать в Excel и PowerPoint на продвинутом уровне"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        title: "Юрист",
        desc: "Формат работы: гибридный\n\nЧто предстоит делать:\n- Юридически сопровождать подразделения по вопросам деятельности на рынке ценных бумаг\n- Разрабатывать и согласовывать договоры по доверительному управлению\n\nМы ждем:\n- Оконченное высшее образование по специальности юриспруденция\n- Английский язык на уровне Upper-Intermediate (B2) и выше"
      }
    ]
  },
  {
