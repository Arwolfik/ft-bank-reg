  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "desc": "Подходит выпускникам онлайн-школ\nФормат работы: гибридный/удаленный\n\nЧто предстоит делать \n- Анализировать данные и разбираться в требованиях бизнеса к качеству данных\n- Помогать бизнес-подразделениям выстраивать процессы по выявлению и устранению ошибок качества данных\n- Участвовать в разборе инцидентов, осуществлять общий мониторинг качества данных и проводить мероприятия по улучшению качества данных\n- Разрабатывать и обновлять документы\n- Обучать пользователей\n\nНеобходимые навыки\n- Уверенное знание SQL на уровне написания сложных запросов (оконные функции, функции ранжирования, CTE)\n- Аналитическое мышление\n\nБудет плюсом\n- Понимание характеристик качества данных и типовых причин проблем с качеством данных\n- Базовые знания о банковских продуктах и основных процессах\n- Базовые знания концепций и принципов Data Governance\n- Знание BI-инструментов"
      },
      {
